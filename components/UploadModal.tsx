...
export default function UploadModal({ onClose, onUploaded }: Props) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl border border-gray-200 w-full max-w-md mx-4 p-5"
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={uploading}
            className="flex-1 py-2 text-sm bg-gray-900 text-white rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50"
          >
            {uploading ? '업로드 중...' : '업로드'}
          </button>
        </div>
