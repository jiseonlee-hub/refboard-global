    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-2xl border border-gray-200 w-full max-w-md mx-4 p-5" onClick={(e) => e.stopPropagation()}>
        ...
        >
          ...
          <input ref={fileRef} type
cat > ~/Downloads/refboard2/components/UploadModal.tsx << 'ENDOFFILE'
'use client'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-2xl border border-gray-200 w-full max-w-md mx-4 p-5" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-4">
          ...
          <textarea value={memo} onChange={(e) => setMemo(e.target.value)} placeholder="참고 내용, 출처, 활용 방향 등 자유롭게..." rows={2} className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:border-gray-400 outline-none transition-colors resize-none" />
        </div>
